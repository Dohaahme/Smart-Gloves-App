...
//   final bool isAdmin;
//   final bool isLogin;
//   const WelcomePage({Key? key, required this.isAdmin, required this.isLogin}) : super(key: key);
//
//   @override
...
//                   Navigator.pop(context);
//                   Navigator.pop(context);
//                   Navigator.push(context, MaterialPageRoute(builder: (context) => WelcomePage(isAdmin: widget.isAdmin,isLogin: widget.isLogin,)));
//                 },
...
//     final languageProvider =Provider.of<LanguageProvider>(context, listen: false);
//     List<String>? cardStrings = prefs.getStringList('welcome_cards');
//     final user = FirebaseAuth.instance.currentUser;
//     String? userId = user?.uid;
...
//       appBar: AppBar(
//         title: Text(
//           languageProvider.localizedStrings['welcomeWords'] ?? 'Welcome words',
//           style: TextStyle(color: Colors.blue),
//         ),
