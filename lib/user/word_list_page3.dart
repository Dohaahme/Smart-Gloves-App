...
//   final bool isAdmin;
//   final bool isLogin;
//   const PlacePage({Key? key, required this.isAdmin,required this.isLogin}) : super(key: key);
//
//   @override
...
//                   Navigator.pop(context);
//                   Navigator.push(context, MaterialPageRoute(builder: (context) => PlacePage(isAdmin: widget.isAdmin,isLogin: widget.isLogin,)));
//                 },
...
//     final languageProvider =Provider.of<LanguageProvider>(context, listen: false);
//     List<String>? cardStrings = prefs.getStringList('place_cards');
...
//       appBar: AppBar(
//         title: Text(
//           languageProvider.localizedStrings['placeswords'] ?? 'places words',
//           style: TextStyle(color: Colors.blue),
//         ),
