...
//   final bool isAdmin;
//   final bool isLogin;
//   const MePage({Key? key, required this.isAdmin, required this.isLogin}) : super(key: key);
//
//   @override
...
//                   Navigator.pop(context);
//                   Navigator.push(context, MaterialPageRoute(builder: (context) => MePage(isAdmin: widget.isAdmin,isLogin: widget.isLogin)));
//                 },
...
//     final languageProvider =Provider.of<LanguageProvider>(context, listen: false);
//     List<String>? cardStrings = prefs.getStringList('me_cards');
//     final user = FirebaseAuth.instance.currentUser;
//     String? userId = user?.uid;
...
//       appBar: AppBar(
//         title: Text(
//           languageProvider.localizedStrings['me'] ?? 'Me',
//           style: TextStyle(color: Colors.blue),
//         ),
