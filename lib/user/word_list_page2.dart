...
//   final bool isAdmin;
//   final bool isLogin;
//   const EmotionsPage({Key? key, required this.isAdmin,required this.isLogin}) : super(key: key);
//
//   @override
...
//                   Navigator.pop(context);
//                   Navigator.push(context, MaterialPageRoute(builder: (context) => EmotionsPage(isAdmin: widget.isAdmin,isLogin: widget.isAdmin,)));
//                 },
...
//     final languageProvider =Provider.of<LanguageProvider>(context, listen: false);
//     List<String>? cardStrings = prefs.getStringList('emotion_cards');
//     final user = FirebaseAuth.instance.currentUser;
//     String? userId = user?.uid;
...
//
//                       _setValue2(1);
//                       final languageProvider2 = Provider.of<LanguageProvider>(con, listen: false);
//                       final languageProvider = Provider.of<LanguageProvider>(context, listen: false);
//                       SharedPreferences prefs = await SharedPreferences.getInstance();
//                       List<Map<String, dynamic>> updatedCards = [..._cards];
//                       _setValue(_englishController.text);
//
//                       // Show overlay message to indicate waiting
//                       showOverlayMessage(context, languageProvider.localizedStrings['PleaseWait'] ?? 'Please wait few seconds to add word...');
//
...
//                       backgroundColor: _isButtonDisabled ? Colors.grey : Colors.blue, // Change button color when disabled
//                     ),
//                   ),
//                 ],
//               );
...
//       appBar: AppBar(
//         title: Text(
//           languageProvider.localizedStrings['emotionswords'] ?? 'Emotions Words',
//           style: TextStyle(color: Colors.blue),
//         ),
