...
class EmotionsPage extends StatefulWidget {
  ...
  const EmotionsPage({Key? key, required this.isLogin}) : super(key: key);
          ...
          actions: [
            ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => EmotionsPage(isLogin: widget.isLogin)));
                },
