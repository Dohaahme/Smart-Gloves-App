...
class WelcomePage extends StatefulWidget {
  ...
  const WelcomePage({Key? key, required this.isLogin}) : super(key: key);
          ...
          actions: [
            ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pop(context);
                  Navigator.pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => WelcomePage(isLogin: widget.isLogin)));
                },
