...
import 'package:test_gproject/admin/word_list_page.dart';
import 'package:test_gproject/admin/word_list_page2.dart';
import 'package:test_gproject/admin/word_list_page3.dart';
import 'package:test_gproject/admin/word_list_page4.dart';
import 'package:test_gproject/admin/word_list_page5.dart';
import 'package:test_gproject/admin/word_list_page6.dart';
...
class _MyAppState extends State<MyAdminApp> {
...
//                   hintText: languageProvider.localizedStrings['chat'] ?? 'Chat',
...
//               ElevatedButton(
//                 onPressed: () async {
//                   // Clear the _cards list before loading new data
//                   _cards.clear();
//
...
//                       if (card['word_en'].toLowerCase() == word.toLowerCase() || card['word_ar'] == word) {
...
//                       SnackBar(
//                         content: Text(
//                           languageProvider.localizedStrings['you should enter text'] ?? 'You Should Enter text',
...
//                       SnackBar(
//                         content: Text(
//                           languageProvider.localizedStrings['usedictionary'] ?? 'Use The Dictionary',
//                           style: TextStyle(color: Colors.blue, fontSize: 20),
//                         ),
//                       ),
//                     );
              ...
              children: [
                Expanded(
                  child: CustomButton(
                    ...
                    page: VerbsPage(isLogin: isLogin,),
                ...
                Expanded(
                  child: CustomButton(
                    ...
                    page: EmotionsPage(isLogin: isLogin,),
                    darkMode: themeProvider.isDarkMode,
                  ),
                ),
              ],
              ...
              children: [
                Expanded(
                  child: CustomButton(
                    ...
                    page: PlacePage(isLogin: isLogin,),
                    darkMode: themeProvider.isDarkMode,
                  ),
                ),
                SizedBox(width: 15),
                Expanded(
                  child: CustomButton(
                    ...
                    page: QuestionPage(isLogin: isLogin,),
                    darkMode: themeProvider.isDarkMode,
                  ),
                ),
              ],
              ...
              children: [
                ...
                Expanded(
                  child: CustomButton(
                    ...
                    page: WelcomePage(isLogin: isLogin,),
                    darkMode: themeProvider.isDarkMode,
                  ),
                ),
              ],
