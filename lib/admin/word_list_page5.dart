...
class MePage extends StatefulWidget {
  ...
  const MePage({Key? key, required this.isLogin}) : super(key: key);
          ...
          actions: [
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(builder: (context) => MePage(isLogin: widget.isLogin)));
              },
                        ...
                        if (_cards[index]['image'].startsWith('/data')) {
                          ...
                          imageWidget = Image.network(
                            ...
                            errorBuilder: (context, error, stackTrace) {
                              ...
                              //alert2(context, languageProvider.localizedStrings['loadyourwords'] ?? 'Load Your Words', languageProvider.localizedStrings['errorload'] ?? "Sorry Can't Load Your Words Now");
